...
export const CHAT_HEADER: string = `Gameday Guru - Beat the Odds`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `[Customized AI by Alex Griffin]`;
export const CLEAR_BUTTON_TEXT: string = `New Bet`;
export const PAGE_TITLE: string = `GAMEDAY GURU`;
