export const OWNER_NAME: string = `Alex Griffin`;
export const OWNER_DESCRIPTION: string = `AI-powered meal and recipe assistant designed to provide personalized meal ideas based on ingredients, dietary preferences, and nutritional needs.`;
